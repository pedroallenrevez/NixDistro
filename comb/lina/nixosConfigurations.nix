{
  lavinox = {pkgs, ...}: {
    ...
    environment.systemPackages = with pkgs; [
      ...
      # fava
      # direnv
      # inputs.nixpkgs.ngrok # unfree
      # # Git & Tools
      # git
      # gh
      # gitoxide
      # ghq
      # #inputs.nixpkgs.sublime-merge # unfree
      # # Nix
      ...
      #       inputs.nixpkgs.vscode-extensions.ms-python.vscode-pylance # unfree
      #       inputs.nixpkgs.vscode-extensions.ms-vscode-remote.remote-ssh # unfree
      #     ]
