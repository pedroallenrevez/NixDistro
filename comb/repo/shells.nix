      ...
      commands = [
        ...
        (withCategory "hexagon" {
          ...
          command = ''
            ...
            if path=$(nix build $PRJ_ROOT#nixosConfigurations.repo-larva.config.system.build.isoImage --print-out-paths --extra-experimental-features nix-command --extra-experimental-features flakes); then
